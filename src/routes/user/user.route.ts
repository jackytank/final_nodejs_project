...
import { allowOnlyGeDi, allowBoth, allowGeDiExceptParams } from '../../middlewares/screenPermission';
...
userRouter.use('/edit/:id', allowGeDiExceptParams({ resAsApi: false, redirUrl: '/logout' }));

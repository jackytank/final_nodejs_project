...
adminUserApiRouter.post('/', allowOnlyGeDi({ resAsApi: true }), AdminUserApiController.save);
...
adminUserApiRouter.get('/csv/export', allowOnlyGeDi({ resAsApi: true }), AdminUserApiController.exportCsv);
adminUserApiRouter.post('/csv/export', allowOnlyGeDi({ resAsApi: true }), AdminUserApiController.exportCsv);
